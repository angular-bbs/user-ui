...
## 后续文章
- 下一个 component 是 modal，当然，也是 model driven。在 `app.component.html` 里这样用 `<tl-modal [modalModel]="modalModel"></tl-modal>` ...
- 另外，后续也会有文章介绍如何将使用 angular-cli 做好的 module 发布到 NPM 上 ...
